<template>
  <div style="display: flex; justify-content: space-between; padding: 20px; background: blue; border-radius: 15px">
    <div>
...
interface Props {
  cityData: CityListItemData;
}

const props = defineProps<Props>();
console.log(props.cityData.weather);
</script>
